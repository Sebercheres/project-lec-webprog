            ...
            <div class="login-form">
                <form action="/donations/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control form-control-lg dropdown-toggle" data-bs-toggle="dropdown"
                            aria-expanded="false" name="type_id" id="type">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="total_sum" class="form-control form-control-lg" placeholder="">
                    </div>

                    <div class="form-group mb-3">
                        <label for="no_rek" class="form-label ">Account Number</label>
                        <input type="text" name="no_rek" class="form-control form-control-lg" placeholder="">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="atas_nama" class="form-control form-control-lg" placeholder="">
                    </div>

                    <div class="form-group mb-3">
                        <label for="final_date" class="form-label ">Final Date</label>
                        <input type="date" id="final_date" name="final_date" class="form-control form-control-lg">
                    </div>

                    <div class="form-group mb-3 pt-2">
                        <button type="submit" class="btn width_1300 form-control form-control-lg text-light"
                            style="background-color: salmon">Add Donation</button>
                    </div>
                </form>
            </div>
        </div>
